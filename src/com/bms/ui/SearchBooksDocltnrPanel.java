...
public class SearchBooksDocltnrPanel extends JPanel{
	   ...
	   private TableModel model;         //using doc listener ,if i type a letter it will 
	   private JTable table;            //bring all the books starting from that so ,action listener 
	   private TableRowSorter sorter;  // should be used .
